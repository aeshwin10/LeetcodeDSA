class Solution { //brilliant problem -> involves bi-partite checking, involves re-rooting.
public:
    ...
    int magnificentSets(int n, vector<vector<int>>& edges) {
        ...
        for(int i=0; i<n; i++){
            if(colors[i]==-1){
                ...
                //For the particular component, I will be finding the max depth/groups that can be formed.
                int ans = 0;
